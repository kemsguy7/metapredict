...
const InvestmentStats = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
      <div>
        <p className="text-white text-sm">YOUR INVESTMENT</p>
        <p className="text-[#F58634] text-xl md:text-2xl font-bold">$1</p>
        <p className="text-green-500 text-sm">UP WINS 200%</p>
      </div>
      <Timer />
      <div className="text-right">
        <p className="text-white text-sm">POTENTIAL RETURN</p>
        <p className="text-[#F58634] text-xl md:text-2xl font-bold">$1</p>
        <p className="text-red-500 text-sm">DOWN WINS 200%</p>
      </div>
    </div>
  );
};
